...
const Footer = () => {
  return (
<footer style={{ backgroundImage: `url(${bgfooter})` }} class="bg-white dark:bg-stone-900 bg-cover">
 ...
 <img src={logo2} alt="logo" className="h-10" />
        ...
        <p
          class="mt-6 max-w-md text-center leading-relaxed text-amber-50 sm:max-w-xs sm:text-left text-amber-50"
        >
        ...
        <ul class="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
          <li>
            <a
              ...
              rel="noreferrer"
              target="_blank"
              class="text-red-500 transition hover:text-red-500 dark:text-stone-50 dark:hover:text-red-500"
            >
            ...
            <li>
              ...
              >
                <svg
                  ...
                  class="size-5 shrink-0 text-gray-900 shadow-sm dark:text-white"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  stroke-width="2"
                ...
                <span class="flex-1 text-gray-700 dark:text-gray-300"> cuetopatrick91@gmail.com </span>
              </a>
            </li>
    ...
    <div class="mt-12 border-t border-gray-100 pt-6 dark:border-gray-800">
      <div class="text-center sm:flex sm:justify-between sm:text-left">
        <p class="text-sm text-gray-500 dark:text-gray-400">
          ...
          <a
            class="inline-block text-red-600 underline transition hover:text-red-600/75 dark:text-red-500 dark:hover:text-stone-50"
            href="#"
          >
            Terms & Conditions
          </a>
          ...
          <a
            class="inline-block text-teal-600 underline transition hover:text-teal-600/75 dark:text-red-500 dark:hover:text-stone-50"
            href="#"
          >
            Privacy Policy
          </a>
